...
class _HomePageState extends State<HomePage> with TickerProviderStateMixin {
  ...
  List<Widget> musicWidgetList(List<Music> musicList, BuildContext blocContext, Music? selectedMusic) {
    ...
    HomePageState homePageState = BlocProvider.of<HomePageBloc>(blocContext).state;

    // so last item still can be seen even the media player is on
    if(homePageState is HomePageInitial) {
      if(homePageState.currentPlayingMusic != null) {
        musicWidgetList.add(
          const SizedBox(
            height: 145.0
          )
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                      children: [
                                        Text(
                                          formatDuration(musicPlayerState.currentAudioPlayerPosition),
                                          maxLines: 1,
                                          overflow: TextOverflow.ellipsis,
                                          style: const TextStyle(
                                            fontSize: 14.0,
